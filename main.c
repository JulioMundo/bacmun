...
//a partir de aqui es el inicio
    ...
    while (true) {
        ...
        if (dia == diaprogramadoc1 && mes == mesprogramadoc1 && an == yearprogramadoc1 && hora == horaprogramadac1 &&
            min == minprogramadoc1 && seg == segprogramadoc1) {
            output_high(PIN_A0);
            lcd_putc("\f");
            lcd_gotoxy(1, 1);
                        ...
                        case 1:
                            ...
                            switch (getValue()) {
                                ...
                                case 2:
                                    ...
                                    lcd_putc("\f");
                                    lcd_gotoxy(1, 1);
                                    printf(lcd_putc, "fecha:%02u/%02u/20%02u", c1diainicial, c1mesinicial,
                                           c1anoinicial);
                                    lcd_gotoxy(1, 2);
                                    printf(lcd_putc, "hora: %02u:%02u:%02u", c1horainicial, c1minutoinicial,
                                           c1segundoinicial);
                                    delay_ms(2000);
                                    lcd_putc("\f");
                                ...
                                case 3:
                                    ...
                                    lcd_putc("\f");
                                    lcd_gotoxy(1, 1);
                                    printf(lcd_putc, "fechp:%02u/%02u/20%02u", diaprogramadoc1, mesprogramadoc1,
                                           yearprogramadoc1);
                                    lcd_gotoxy(1, 2);
                                    printf(lcd_putc, "horp: %02u:%02u:%02u", horaprogramadac1, minprogramadoc1,
                                           segprogramadoc1);
                                    delay_ms(2000);
                                    break;
                            }
                            break; //del switch, este se queda para que no siga con seleccionaste c2
                            //break; //del caso 1 selector de celda posiblemente este se vaya y sea el de arriba
                        case 02:
                            lcd_putc("\f");
                            lcd_gotoxy(1, 1);
